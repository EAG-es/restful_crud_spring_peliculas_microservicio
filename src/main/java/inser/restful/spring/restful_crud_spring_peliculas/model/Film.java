...
@Table(name = "film")
@NamedQueries({
    @org.hibernate.annotations.NamedQuery(name = "Film.findAll", query = Film.SELECT_findAll),
    @org.hibernate.annotations.NamedQuery(name = "Film.findByTitle", query = Film.SELECT_findByTitle)
})
public class Film implements Serializable {
    ...
    public static final String SELECT_findByTitle = "SELECT p FROM Film p WHERE p.description like :description";
    public static final String SELECT_findByTitle_order = SELECT_findByTitle + " ORDER BY p.";
